        ...
        renderAttendanceTrend: function (canvasId, trend) {
            ...
            if (data.totals.length) {
                datasets.push({
                    ...
                    backgroundColor: teacher ? "rgba(128, 0, 32, 0.18)" : (superAdmin ? "rgba(245, 158, 11, 0.2)" : (admin ? "rgba(126, 34, 206, 0.18)" : greenLight)),
                    tension: 0.3,
                    fill: true
                });
            }
            if (datasets.length === 0) {
                datasets.push({
                    ...
                    backgroundColor: teacher ? "rgba(165, 42, 42, 0.2)" : (superAdmin ? "rgba(59, 130, 246, 0.2)" : (admin ? purpleLight : greenLight)),
                    tension: 0.3,
                    fill: false
                });
            }
