...
public class SuperAdminAttendanceController {
    ...
    public String dashboard(Model model, Authentication auth) {
        ...
        return "superadmin/attendance/dashboard";
    }
    ...
    public String trends(Model model, Authentication auth) {
        ...
        model.addAttribute("profilePhotoUrl", profilePhotoService.resolveProfilePhotoUrl(auth.getName()));
        return "superadmin/attendance/trends";
    }
    ...
    public String create(Model model, Authentication auth) {
        ...
        model.addAttribute("profilePhotoUrl", profilePhotoService.resolveProfilePhotoUrl(auth.getName()));
        return "superadmin/attendance/create";
    }
    ...
    public String departments(Model model, Authentication auth) {
        ...
        model.addAttribute("department", new Department());
        model.addAttribute("profilePhotoUrl", profilePhotoService.resolveProfilePhotoUrl(auth.getName()));
        return "superadmin/attendance/departments";
    }
    ...
    public String updateDepartment(@PathVariable Long id,
        ...
        return "redirect:/superadmin/attendance/departments";
    }
    ...
    public String addDepartmentFromPage(@ModelAttribute Department department, RedirectAttributes redirect) {
        ...
        return "redirect:/superadmin/attendance/create#department";
    }
    ...
    public String students(Model model,
        ...
        model.addAttribute("student", student);
        model.addAttribute("nextStudentNumber", student.getStudentNumber());
        return "superadmin/attendance/students";
    }
    ...
    public String addStudent(@ModelAttribute Student student,
        ...
        try {
            ...
            if ("create".equalsIgnoreCase(returnTo)) {
                ...
                return "redirect:/superadmin/attendance/students?viewAll=true";
            }
        } catch (Exception e) {
            redirect.addFlashAttribute("error", e.getMessage());
            if ("create".equalsIgnoreCase(returnTo)) {
                return "redirect:/superadmin/attendance/create#student";
            }
        }
    ...
    private String buildStudentsRedirect(Long departmentId,
        ...
        if (params.isEmpty()) {
            return "redirect:/superadmin/attendance/students";
        }
        return "redirect:/superadmin/attendance/students?" + String.join("&", params);
    }
    ...
    public String teachers(Model model,
        ...
        model.addAttribute("profilePhotoUrl", profilePhotoService.resolveProfilePhotoUrl(auth.getName()));
        return "superadmin/attendance/teachers";
    }
    ...
    public String addTeacher(@ModelAttribute Teacher teacher,
        ...
        return "redirect:/superadmin/attendance/create#teacher";
    }
    ...
    public String subjects(Model model,
        ...
        subject.setDepartment(new Department());
        model.addAttribute("subject", subject);
        return "superadmin/attendance/subjects";
    }
    ...
    public String addSubject(@ModelAttribute Subject subject, RedirectAttributes redirect) {
        ...
        return "redirect:/superadmin/attendance/create#subject";
    }
    ...
    public String sections(Model model,
        ...
        model.addAttribute("section", section);
        return "superadmin/attendance/sections";
    }
    ...
    public String addSection(@ModelAttribute Section section, RedirectAttributes redirect) {
        ...
        return "redirect:/superadmin/attendance/create#section";
    }
    ...
    private String buildTeachersRedirect(Long departmentId, String search, String status) {
        ...
        if (params.isEmpty()) {
            return "redirect:/superadmin/attendance/teachers";
        }
        return "redirect:/superadmin/attendance/teachers?" + String.join("&", params);
    }
    ...
    private String buildSubjectsRedirect(Long departmentId, String search) {
        ...
        if (params.isEmpty()) {
            return "redirect:/superadmin/attendance/subjects";
        }
        return "redirect:/superadmin/attendance/subjects?" + String.join("&", params);
    }
    ...
    private String buildSectionsRedirect(Long departmentId, String yearLevel) {
        ...
        if (params.isEmpty()) {
            return "redirect:/superadmin/attendance/sections";
        }
        return "redirect:/superadmin/attendance/sections?" + String.join("&", params);
    }
}
